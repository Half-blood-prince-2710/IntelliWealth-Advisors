...
const getBudgetList = async () => {
  ...
  // Call these functions after setting the budget list
    ...
    try {
      const result = await db
        .select({
          ...
          totalAmount:
            sql`SUM(CAST(${Incomes.amount} AS NUMERIC))`.mapWith(
              Number
            ),
        })
        .from(Incomes)
  ...
  return (
    <div className='p-8 bg-'>
      ...
      <p className='text-gray-500'>
        Here's what happenning with your
        money, Lets Manage your expense
      </p>
